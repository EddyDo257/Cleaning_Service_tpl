                                            ...
                                            <div class="col-8 col-sm-6">
                                              ...
                                              <div class="col-8 col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="avenue" value="<?php echo $row['service_name'] ?>" style="color: black;font-weight: bold;font-size: 20px;" class="form-control" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="tel" class="col-sm-5 control-label">Facility</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="avenue" value="<?php echo $row['facility'] ?>" style="color: black;font-weight: bold;font-size: 20px;" class="form-control" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
