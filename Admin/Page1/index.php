                ...
                <div class="row">
                                    ...
                                    <div class="stat-widget-five">
                                        ...
                                        <div class="stat-content">
                                            <div class="text-left dib">
                                                ...
                                                <div class="stat-heading">Total Booking services</div>
                                            </div>
                                        </div>

                                    </div>
                                </div>
                                <a class="btn btn-outline-success" href="booking.php" role="button">See Details</a>
                            </div>
                           <?php
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="card">
                            ...
                            <a class="btn btn-outline-success" href="employee.php" role="button">See Details</a>
                        </div>
                        <?php
                            ...
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span><?php echo $rowcount; ?></span></div>
                                            <div class="stat-heading">All customer</div>
                                        </div>
                                    </div>

                                </div>
                            </div>
                            <a class="btn btn-outline-success" href="customer.php" role="button">See Details</a>
                        </div>
                        <?php
                    ...
                    <div class="col-lg-4 col-md-6">
                        <?php
                          $con = mysqli_connect('localhost', 'root', '', 'service');
                              ...
                              // SQL query to display row count
                              // in building table
                              $sql = "SELECT * from assign where task='pending...'";
                    ...
                    <div class="col-lg-4 col-md-6">
                        <?php
                          $con = mysqli_connect('localhost', 'root', '', 'service');
                              ...
                              // SQL query to display row count
                              // in building table
                              $sql = "SELECT * from assign where task='Complete'";
