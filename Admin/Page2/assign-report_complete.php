...
$count="select * from assign Where employee_name='$name1' AND task='Complete' LIMIT 0,10"; // SQL to get 10 records 
require('fpdf.php');
...
function Header()
{
 ...
 $this->SetFont('Arial','B',13);
    ...
    $this->Cell(80);
    // Title
    $this->Cell(80,10,'Assigned Complete order List',1,0,'C');
    // Line break
    $this->Ln(20);
}
// Page footer
