...
///////////////////////////////////////////////////////check username////////////////////////////////
    ...
    if ($row['username'] == $username OR $row['email'] == $email AND $row['password'] == $password) {
        ...
        <div class="col-md-5">
          ...
          <form class="login-form" action="#" method="POST">
            ...
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" name="username" placeholder="Enter Username or Email" aria-label="Username" aria-describedby="basic-addon1">
            </div>
            <div class="input-group mb-3">
